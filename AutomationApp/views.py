...
def marketingaspect(request):
    ...
    try:
        ...
        while febcountRO<februaryROii.count():
            febuaryROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='02',CusName=febuaryROii[febcountRO]).Count('DateTime', distinct=True)
            if febuaryROi==2:
                MAINfebROcounts+=1
            febcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while marcountRO<marchROii.count():
            marchROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='03',CusName=marchROii[marcountRO]).Count('DateTime', distinct=True)
            if marchROi==2:
                MAINmarROcounts+=1
            marcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while aprcountRO<aprilROii.count():
            aprilROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='04',CusName=aprilROii[aprcountRO]).Count('DateTime', distinct=True)
            if aprilROi==2:
                MAINaprROcounts+=1
            aprcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while maycountRO<mayROii.count():
            mayROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='05',CusName=mayROii[maycountRO]).Count('DateTime', distinct=True)
            if mayROi==2:
                MAINmayROcounts+=1
            maycountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while juncountRO<juneROii.count():
            juneROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='06',CusName=juneROii[juncountRO]).Count('DateTime', distinct=True)
            if juneROi==2:
                MAINjunROcounts+=1
            juncountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while julcountRO<julyROii.count():
            julyROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='07',CusName=julyROii[julcountRO]).Count('DateTime', distinct=True)
            if julyROi==2:
                MAINjulROcounts+=1
            julcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while augcountRO<augustROii.count():
            augustROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='08',CusName=augustROii[augcountRO]).Count('DateTime', distinct=True)
            if augustROi==2:
                MAINaugROcounts+=1
            augcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while septcountRO<septemberROii.count():
            septemberROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='09',CusName=septemberROii[septcountRO]).Count('DateTime', distinct=True)
            if septemberROi==2:
                MAINseptROcounts+=1
            septcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while octcountRO<octoberROii.count():
            octoberROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='10',CusName=octoberROii[octcountRO]).Count('DateTime', distinct=True)
            if octoberROi==2:
                MAINoctROcounts+=1
            octcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while novcountRO<novemberROii.count():
            novemberROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='11',CusName=novemberROii[novcountRO]).Count('DateTime', distinct=True)
            if novemberROi==2:
                MAINnovROcounts+=1
            novcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while deccountRO<decemberROii.count():
            decemberROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='12',CusName=decemberROii[deccountRO]).Count('DateTime', distinct=True)
            if decemberROi==2:
                MAINdecROcounts+=1
            deccountRO+=1
    except Sales.DoesNotExist:
