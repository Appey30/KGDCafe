...
def marketingaspect(request):
    ...
    try:
        ...
        while jancountRO<januaryROii.count():
            januaryROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='01',CusName=januaryROii[jancountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if januaryROi==2:
                MAINjanROcounts+=1
            jancountRO+=1
    ...
    try:
        ...
        while febcountRO<februaryROii.count():
            febuaryROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='02' or '01',CusName=febuaryROii[febcountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if febuaryROi==2:
                MAINfebROcounts+=1
            febcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while marcountRO<marchROii.count():
            marchROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='03' or '02',CusName=marchROii[marcountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if marchROi==2:
                MAINmarROcounts+=1
            marcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while aprcountRO<aprilROii.count():
            aprilROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='04' or '03',CusName=aprilROii[aprcountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if aprilROi==2:
                MAINaprROcounts+=1
            aprcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while maycountRO<mayROii.count():
            mayROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='05' or '04',CusName=mayROii[maycountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if mayROi==2:
                MAINmayROcounts+=1
            maycountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while juncountRO<juneROii.count():
            juneROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='06' or '05',CusName=juneROii[juncountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if juneROi==2:
                MAINjunROcounts+=1
            juncountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while julcountRO<julyROii.count():
            julyROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='07' or '06',CusName=julyROii[julcountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if julyROi==2:
                MAINjulROcounts+=1
            julcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while augcountRO<augustROii.count():
            augustROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='08' or '07',CusName=augustROii[augcountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if augustROi==2:
                MAINaugROcounts+=1
            augcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while septcountRO<septemberROii.count():
            septemberROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='09' or '08',CusName=septemberROii[septcountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if septemberROi==2:
                MAINseptROcounts+=1
            septcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while octcountRO<octoberROii.count():
            octoberROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='10' or '09',CusName=octoberROii[octcountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if octoberROi==2:
                MAINoctROcounts+=1
            octcountRO+=1
    except Sales.DoesNotExist:
    ...
    try:
        ...
        while novcountRO<novemberROii.count():
            novemberROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='11' or '10',CusName=novemberROii[novcountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if novemberROi==2:
                MAINnovROcounts+=1
            novcountRO+=1
    ...
    try:
        ...
        while deccountRO<decemberROii.count():
            decemberROi=Sales.objects.filter(DateTime__year='2022',DateTime__month='12' or '11',CusName=decemberROii[deccountRO]).annotate(date=TruncDate('DateTime'),day=TruncDay('DateTime'),hour=TruncHour('DateTime', tzinfo=melb),minute=TruncMinute('DateTime')).values('date', 'day', 'hour', 'minute').distinct()
            if decemberROi==2:
                MAINdecROcounts+=1
            deccountRO+=1
